...
ActiveRecord::Schema.define(version: 2020_03_13_120506) do
  ...
  create_table "assemblies", force: :cascade do |t|
    ...
    t.bigint "ownable_id"
    t.index ["ownable_type", "ownable_id"], name: "index_assemblies_on_ownable_type_and_ownable_id"
  end
  ...
  create_table "departments", force: :cascade do |t|
    ...
    t.string "ownable_type"
    t.bigint "ownable_id"
    t.index ["ownable_type", "ownable_id"], name: "index_departments_on_ownable_type_and_ownable_id"
  end
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.string "ownable_type"
    t.bigint "ownable_id"
    t.index ["ownable_type", "ownable_id"], name: "index_locations_on_ownable_type_and_ownable_id"
  end
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "assembly_id"
    t.index ["assembly_id"], name: "index_recipes_on_assembly_id"
    t.index ["ownable_type", "ownable_id"], name: "index_recipes_on_ownable_type_and_ownable_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "invitation_group_token"
  ...
  add_foreign_key "recipes", "assemblies"
